function [mih,plotHandle] = spotsVtime(analData1,analData2,bins,binsOfInterest,fitInputs,tm,tx,fignum)
...
% 
% As for initialFractionBin, but the curves are not x-axis shifted. A bit
% of a mess
%
% INPUTS
...
hold on;plotHandle = plot(sints(:,1),sints(:,2),'LineWidth',1);shg
try
    mih.Af = Af;
    mih.k0 = k0;
end
