function [mih,plotHandle] = initialFraction5(cia,nukesMat,normalization,fitInputs,tm,tx,fignum)
% [mih,plotHandle] = initialFraction5(cia,nukesMat,normalization,fitInputs,tm,tx,fignum)
% 
% THE two step initial bind script. Any edit here should also be made in
% initialFraction6.
