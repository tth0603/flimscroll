...
% this is an empirical hack (see bins section of t1p54l.m; basically, if we have too few nukes in an experiment, let's correct for that:
if mx/numberOfReps < 44 %44 was chosen bc that's twice the median value of nukes/bin across all experiemnts (we look at 2 bins), and here we're looking at two bins
    mx = 44*numberOfReps;
end
