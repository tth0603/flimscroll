function pc=Remove_Close_AOIs_v1Fli(aoiinfo2,Unique_Landing_Radius)
%
...
for indx=1:landingcount
    ...
    if sum(logik)==landingcount-1
        ...
        ListIndx=ListIndx+1;
    %else
        %here to add a way to keep one spot, but I haven't taken the time to figure out how 
    end
end
