...
%
% function build_2d_mapstruc_aois_frmsFli(folder,aoiRad,frms,ave,FitData,startparameter,handles)
% mapstruc2d=build_2d_mapstruc_aois_frmsFli(folder,pixnum,frms,ave,FitData,inputstartparm,handles)
%
...
%
%   From Harden edits:
%       startparameter dictactes whether [1] or not [2] we use a driftlist.
%       a scaler.
%
% Copyright 2015 Larry Friedman, Brandeis University.
% edit Harden 2018 (the help menu here has not been edited to reflect my
% edits.)
...
aoiinf = varargin{5};                                                %[framenumber ave x y pixnum aoinumber];
...
%     end
    ...
    %inputstartparm=1; %i dont thing we want nmoving AOI as that is to do with a DL
    %TH nvm, we've added in DL technology. a much better way to track
    %nuclei
    inputstartparm = varargin{6};
    ...
    mapstruc_cell(:,indx)=build_mapstruc_cell_columnFli(oneaoiinf,inputstartparm,folder,folderuse,varargin{7});  %need to pass handles here bc of DL
end
