function pc=construct_driftlist_time_v1Fli(xy_cell,vid,CorrectionRange,SequenceLength,Polyorderxy,varargin)
%
...
%
% Usage:
%(1) drifts_time= construct_driftlist_time_v1Fli(xy_cell,vid,CorrectionRange,SequenceLength,Polyorderxy,<SG_Smooth>)
...
%TH don't need to plot in final script 
...
tm= vid.ttb;     %TH to correct for the fact that here ttb is in s starting from (usu) zero (or whatever the user dictates)
