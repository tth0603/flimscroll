function pc=build_mapstruc_cell_columnFli(aoiinf,startparm,folder,folderuse,varargin)
%
% function build_mapstruc_cell_column(aoiinf,startparm,folder,folderuse,handles)
%
