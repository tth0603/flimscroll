function maxProjLSo2(acqnDate,dataDir,dirVect,varargin)
...
% 1. load it (run: load C:\Users\tth12\matlab\fig_files\LSdataAnal\fileLocation.dat -mat) 
...
load fileLocationsO2.dat -mat % a pre defined file. see help above
%for O2 the ideal fp at present is: /n/files/SysBio/DEPACE LAB/People/Tim/ms2_data
% but I am yet to test if I have access to this. Presently I use transfer
% to place them in /home/tth12/matlab/image-data/
...
for i = 1:len
    ...
    %fileOutPath = [maxPath filesep acqnDate '-' dataDir '-test.tiff'];
