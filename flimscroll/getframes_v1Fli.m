function pc=getframes_v1Fli(handles)
%
...
% if isfield(handles,'TiffFolder') %TH
...
imagenum = round(get(handles.slider,'Value')); %TH
ave=1;  %TH   % Fetch the number of frames to ave
                                                  % for display purposes
% if get(handles.ImageSource,'Value') ==1     %TH    % popup menu 'Tiff_Folder'
