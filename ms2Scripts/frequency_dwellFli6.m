function [mih,plotHandle] = frequency_dwellFli6(varargin)
...
%
% this version is the same as v2, but doesn't use the time after the last
% event when calculating event frequencies
%
